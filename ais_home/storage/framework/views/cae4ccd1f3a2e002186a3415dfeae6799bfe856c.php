...
<div class="tuijian">
    ...
    <div class='song' attr='<?php echo e($v->music_id); ?>'>
        <img src="http://www.mymusic.com<?php echo e($v->music_img); ?>" alt="" width='300px' height='250px' />
        <span><?php echo e($v->music_name); ?></span>
    </div>
    <?php endforeach; ?>
</div>
<div class="newsong">
...
<script type="text/javascript">
    ...
    $(".song").click(function()
    {
        ...
        $.ajax({
           type: "POST",
           url: "joinlisten",
           data: "music_id="+music_id+"&_token=<?php echo e(csrf_token()); ?>",
           // dataType:'json',
